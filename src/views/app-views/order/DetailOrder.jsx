...
import { fetchOneOrder } from "@/store/features/orders"
import { fetchAllCustomer } from "@/store/features/customers"
import { fetchAllProduct } from "@/store/features/products"
...
export const DetailOrder = () => {
  ...
  const getData = useCallback(async (id) => {
    try {
      await dispatch(fetchOneOrder(id)).unwrap().then(() => {

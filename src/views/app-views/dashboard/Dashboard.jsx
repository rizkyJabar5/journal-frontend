...
import StatisticWidget from '@/component/shared-components/StatisticWidget';
import React, { useEffect, useCallback } from "react";
import { useDispatch, useSelector } from 'react-redux';
import { fetchSumStore, fetchSumLedger } from '@/store/features/reports';
import { WithRouter } from '@/component/WithRouter';
import { AllProduct } from "@/views/app-views/product/AllProduct";
...
export const DefaultDashboard = () => {
  ...
  return (
    <>
      ...
      <AllProduct noTitle={true} ></AllProduct>
    </>
  )
}

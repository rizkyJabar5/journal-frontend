...
import { fetchAllExpense } from '@/store/features/expenses';
import { fetchAllSupplier } from '@/store/features/suppliers';
...
export const AllExpense = () => {
	...
	const tambahPengeluaran = async (values) => {
		...
		formData.append('additionalInformation', expense.additionalInformation);
...
export default WithRouter(AllExpense);

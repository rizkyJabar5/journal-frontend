...
import { showAuthMessage, showLoading, hideAuthMessage, authenticated, register, sendActivation } from '@/store/features/auth';
...
export const RegisterForm = ({ showLoading, loading, message, showMessage, showAuthMessage }) => {
